document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".t-a-navigation-list");
  const headerRef = document.querySelector(".t-a-header");
  const navigationRef = document.querySelector(".t-a-navigation");
  ...
  document.querySelectorAll(".t-a-navigation-link").forEach((n) =>
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".t-a-toggle-button img");
